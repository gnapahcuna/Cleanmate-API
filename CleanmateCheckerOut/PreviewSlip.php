<?php
    ...
    $stmt = "select	ops_order.MemberDiscount,uac_customer.MemberTypeID,
		...
		ops_orderdetail.ProductNameTH,ops_orderdetail.ServiceNameTH,
		ops_orderdetail.ProductNameTH,ops_orderdetail.Amount,ops_orderdetail.ServiceNameTH,
		...
		SUM(case when ops_orderdetail.IsCancel =1 then ops_orderdetail.Amount else 0 end) as IsCancel,
		...
		SUM(case when (ops_orderdetail.DiscountAmount IS NULL OR ops_orderdetail.DiscountAmount=0)then 0 else ops_orderdetail.DiscountAmount end) as DiscountAmount
