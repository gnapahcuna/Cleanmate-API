<?php
    ...
    $stmt = "select ProductNameTH,ProductNameEN,ProductID,count(ProductNameTH) as Num from ops_orderdetail Where OrderNo='".$_POST['orderNo']."' group by ProductNameTH,ProductNameEN,ProductID";
