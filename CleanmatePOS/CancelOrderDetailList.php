<?php
    ...
    $stmt = "select ProductNameTH,ProductNameEN,ProductID,count(ProductNameTH) as Num from ops_orderdetail Where OrderNo='".$_GET['orderNo']."' group by ProductNameTH,ProductNameEN,ProductID";
