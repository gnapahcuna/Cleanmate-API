<?php
    ...
    $stmt = "select OrderDetailID,OrderNo,ProductNameTH,ProductNameEN,Barcode,IsImage from ops_orderdetail where OrderNo='".$_GET['orderNo']."' AND ProductID='".$_GET['productID']."'";
