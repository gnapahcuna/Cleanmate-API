...
CASE WHEN '".$_GET['dates']."' between EffectiveDate and ExpireDate THEN '#1' ELSE '#2' END as Checked
...
where acc.Username='".$_GET['user']."' AND acc.Password='".$_GET['pass']."' and (AccoutType=2 OR AccoutType=1) and (ProgramName='App_รับถุงผ้าที่ร้าน' or ProgramName='App_รับถุงผ้าเข้าโรงงาน')";
